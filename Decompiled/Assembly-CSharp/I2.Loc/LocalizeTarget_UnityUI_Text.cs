...
public class LocalizeTarget_UnityUI_Text : LocalizeTarget<Text>
{
	...
	private const bool mFixedAlignment = true;
	...
	public override void DoLocalize(Localize cmp, string mainTranslation, string secondaryTranslation)
	{
		...
		if (mInitializeAlignment)
		{
			...
			InitAlignmentFixed(mAlignmentWasRTL, mTarget.alignment, out mAlignment_LTR, out mAlignment_RTL);
		}
		else
		{
			InitAlignmentFixed(mAlignmentWasRTL, mTarget.alignment, out var alignLTR, out var alignRTL);
	...
	private void InitAlignmentFixed(bool isRTL, TextAnchor alignment, out TextAnchor alignLTR, out TextAnchor alignRTL)
	{
